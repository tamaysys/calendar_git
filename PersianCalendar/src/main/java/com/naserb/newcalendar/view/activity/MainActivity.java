...
import com.naserb.newcalendar.databinding.ActivityMainBinding;
import com.naserb.newcalendar.service.ApplicationService;
import com.naserb.newcalendar.util.CalendarUtils;
import com.naserb.newcalendar.util.TypefaceUtils;
...
import com.naserb.newcalendar.view.fragment.CompassFragment;
import com.naserb.newcalendar.view.fragment.ConverterFragment;
import com.naserb.newcalendar.view.preferences.SettingsFragment;
...
import static com.naserb.newcalendar.Constants.DEFAULT_APP_LANGUAGE;
import static com.naserb.newcalendar.Constants.LANG_AR;
import static com.naserb.newcalendar.Constants.LANG_EN_IR;
import static com.naserb.newcalendar.Constants.LANG_EN_US;
import static com.naserb.newcalendar.Constants.LANG_FA;
import static com.naserb.newcalendar.Constants.LANG_FA_AF;
import static com.naserb.newcalendar.Constants.LANG_PS;
import static com.naserb.newcalendar.Constants.LANG_UR;
import static com.naserb.newcalendar.Constants.LIGHT_THEME;
import static com.naserb.newcalendar.Constants.PREF_APP_LANGUAGE;
import static com.naserb.newcalendar.Constants.PREF_HOLIDAY_TYPES;
import static com.naserb.newcalendar.Constants.PREF_MAIN_CALENDAR_KEY;
import static com.naserb.newcalendar.Constants.PREF_NOTIFY_DATE;
import static com.naserb.newcalendar.Constants.PREF_OTHER_CALENDARS_KEY;
import static com.naserb.newcalendar.Constants.PREF_PERSIAN_DIGITS;
import static com.naserb.newcalendar.Constants.PREF_SHOW_DEVICE_CALENDAR_EVENTS;
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.other:
                ...
                try {
                    ...
                    intent.setData(Uri.parse("bazaar://collection?slug=by_author&aid=" + "micron"));
                    intent.setPackage("com.farsitel.bazaar");
                    startActivity(intent);
                }
                catch (Exception e) {}
